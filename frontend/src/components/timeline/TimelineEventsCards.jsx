      ...
      <div className="lg:p-12 p-8 bg-[#000509]">
        <div className=" m-5 p-6 rounded-[2rem]" id="glasseffect">
          ...
          <div className="text-center p-5">
            <h3 className="text-default-600 lg:text-lg text-[0.8rem]">
              Click participate for the Workshops you want to attend and the
              click Submit to confirm you selections!
            </h3>
            <h3 className="text-default-600 lg:text-lg text-[0.8rem]">
              (Keep in mind you won't be able to select workshops happening
              ...
              <div key={index} className="py-5 m-auto">
                <Card className="py-4 text-xs lg:h-[20rem] h-[20rem] lg:w-[20rem] w-[12rem]">
                  <CardHeader className="pb-0 pt-2 px-4 flex-col items-center">
                    ...
                    <h4 className="font-bold lg:text-[1.3rem] p-1.5">
                      {event[1]}
                    </h4>
                  </CardHeader>
        ...
        <div className="lg:p-16 p-7 text-white">
          <div className="" id="glasseffect">
            <div className="text-white  bg-center rounded-3xl lg:p-28 p-0">
              <img src={ctfevents} alt="ctf" className="col-span-2 mx-auto" />
              <div className="grid  md:grid-cols-2 grid-cols-1 rounded-3xl ">
                <div className="flex justify-center align-middle">
                  <img className="m-auto mt-6 p-4" src={hecker} alt="ctf"></img>
                </div>
                <div className="flex-col justify-center align-middle p-3">
                  <img
                    className="h-72 w-72 object-center m-auto"
                    src={gr}
                    alt="gr"
                  ></img>
                  <p className="text-center w-5/6 m-auto">
                    Magnam et id commodi non quia. Cumque sed aut
                    architecto.Laboriosam est a quae aliquam. Tempora et impedit
                    eos praesentium voluptatem. Reprehenderit unde consequatur
                    quia. Dignissimos provident error fugit. Ut exercitationem
                    impedit voluptas consequatur ut dicta. Provident dicta
                    magnam est qui porro. Ratione similique dignissimos beatae.
                    Qui repellat quam eaque dolores.
                  </p>
                </div>
                <div className="flex-col flex m-auto justify-center align-middle md:text-3xl text-xl p-6">
                  <div className="pt-4 pl-10 flex flex-row">
                    <img src={calen} alt="calen"></img>
                    <span className="pt-4 pl-10 [font-family:'Inter-Medium',Helvetica] font-semibold">
                      {" "}
                      Date: 31-01-2024
                    </span>
                  </div>
                  <div className="pt-6 pl-10 flex flex-row">
                    ...
                    <span className="pt-1 pl-10 [font-family:'Inter-Medium',Helvetica] font-semibold">
                      {" "}
                      Time: 12:30 PM
                    </span>
                  </div>
                  <div className="pt-6 pl-10 flex flex-row">
                    ...
                    <span className="pt-2 pl-10 [font-family:'Inter-Medium',Helvetica] font-semibold">
                      {" "}
                      Mode: Online
                    </span>
                  </div>
                ...
                <div className="p-6 justify-center align-middle">
                  ...
                  <div className="flex flex-col items-center justify-center">
                    <div className="p-6 flex-col items-center">
                      <img className="w-36 h-36" src={P1} alt="p1"></img>
                    </div>
                    <div className="flex flex-row justify-center flex-wrap">
                      <div className="p-6 flex-col items-center">
                        <img className="w-36 h-36" src={P2} alt="p2"></img>
                      </div>
                      <div className="p-6 flex-col items-center">
                        <img className="w-36 h-36" src={P3} alt="p3"></img>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className=" bottom-0 lg:block z-[9999] lg:h-fit h-24 bg-[#000509] w-full pt-2 event-submit">
          <div className="text-center text-white">
            <h4 className="lg:p-5 p-3 text-[#11A8E4] lg:text-lg text-[0.4rem] font-semibold">
              PRESS SUBMIT TO CONFIRM YOUR SELECTION!
            </h4>
